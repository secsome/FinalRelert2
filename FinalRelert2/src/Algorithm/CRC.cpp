...
int CRCEngine::operator()(void* buffer, int length)
{
	return (*this)((const void*)buffer, length);
}

int CRCEngine::operator()(const void* buffer, int length)
{
...
bool CRCEngine::Buffer_Needs_Data() const
{
	return Index != 0;
}

int CRCEngine::Value() const
{
...
int CRCEngine::Memory(const void* data, int bytes, int crc)
{
